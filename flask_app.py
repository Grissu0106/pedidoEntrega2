...
users = {
    ...
    # NUEVO USUARIO AÑADIDO para que puedas entrar como "user":
    'user': {'password': 'userpass', 'role': 'driver'} 
}
...
def login():
    ...
    # CORRECCIÓN: Maneja el método GET devolviendo el formulario de login.
    return render_template('login.html')
...
def ver_mapa():
    ...
    # Nota: La ruta original 'home/iamaterlal/mysite/static/mapa_cbb.html' es específica de un entorno.
    # Flask lo manejará directamente sin necesidad de guardar el archivo si usamos m._repr_html_()
    path = 'home/iamaterlal/mysite/static/mapa_cbb.html' # Mantenemos la ruta original como comentario
